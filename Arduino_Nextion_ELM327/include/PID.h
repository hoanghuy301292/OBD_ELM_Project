...
#define PID_FUEL_TRIM_B1_S1               "01 15" // (B-128) * 100/128 (if B==$FF, sensor is not used in trim calc)
#define PID_FUEL_TRIM_B1_S1               "01 16" // (B-128) * 100/128 (if B==$FF, sensor is not used in trim calc)
#define PID_FUEL_TRIM_B1_S1               "01 17" // (B-128) * 100/128 (if B==$FF, sensor is not used in trim calc)
#define PID_FUEL_TRIM_B1_S1               "01 18" // (B-128) * 100/128 (if B==$FF, sensor is not used in trim calc)
#define PID_FUEL_TRIM_B1_S1               "01 19" // (B-128) * 100/128 (if B==$FF, sensor is not used in trim calc)
#define PID_FUEL_TRIM_B1_S1               "01 1A" // (B-128) * 100/128 (if B==$FF, sensor is not used in trim calc)
#define PID_FUEL_TRIM_B1_S1               "01 1B" // (B-128) * 100/128 (if B==$FF, sensor is not used in trim calc)
// End Special Case.
